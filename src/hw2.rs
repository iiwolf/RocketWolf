...
fn sutton2_7(){
    ...
    utility::result("Propellant Mass Flow",mdot,"lbm/s");
...
fn sutton2_8(){
    ...
    utility::result("Effective Exhaust Velocity", c, "ft/s");
}
...
fn SP02B(){
    ...
    let F = At*P1*f32::sqrt(
            ...
            * (1.0 - f32::powf(P2/P1,(k - 1.0)/k)))
            + (P2 - P3)*A2;
    utility::result("Thrust", F, "N");

    //which allows us to calculate stress on area At
    let sigma = F / At;
    utility::result("Stress", sigma, "N / m^2");
